...
<head>
        ...
        <meta charset="utf-8">
        <title>Change Password | Tshitshithe</title>
    ...
    <body class="authentication-bg"style="background: url('assets/images/bg.jpg');background-size: cover;background-position: center !important;">
    <style>
        .card{
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="p-3">
                                    ...
                                    <p class="text-muted text-center mb-4">Hello {{ $username }}, create your new passwoprd here</p>
                                    @if(Session::has('fail'))
                                    ...
                                    @endif
                                    <form class="form-horizontal" action="{{ url('/new-password') }}" method="post">
                                    @csrf
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="token" class="form-control" hidden value="{{ $token }}">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label" for="userpassword"style="margin-left:2%">Enter new password</label>
                                            <input type="password" name="password" class="form-control" id="userpassword" style="border-radius:25rem ! important;">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label" for="userpassword" style="margin-left:2%">Confirm new password</label>
                                            <input type="password" name="cpassword" class="form-control" id="userpassword" style="border-radius:25rem ! important;">
                                        </div>

                                        <div class="mb-3">
                                            <div class="text-end">
                                                <button class="btn w-md waves-effect waves-light" type="submit"style="border-radius:25rem ! important;margin-left:72%;background: rgb(8, 21, 70);">Submit</button>
                                            </div>
                                        </div>
                                    </form>
