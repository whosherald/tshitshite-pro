                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="p-3">
                                    <h4 class="font-size-18 mt-2 text-center">forgotten password.</h4>
                                    ...
                                    @endif
                                    <form class="form-horizontal" action="{{ url('/new-forgottenpassword') }}" method="post">
                                    @csrf
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="userpassword">Enter new password</label>
                                            <input type="password" name="password" class="form-control" id="userpassword" placeholder="Enter email">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label" for="userpassword">Confirm new password</label>
                                            <input type="password" name="cpassword" class="form-control" id="userpassword" placeholder="Enter email">
                                        </div>

                                        <div class="mb-3">
                                            <div class="text-end">
                                                <button class="btn w-md waves-effect waves-light" type="submit"style="border-radius:25rem ! important;margin-left:59%;background: rgb(8, 21, 70);">Submit</button>
                                            </div>
                                        </div>
                                    </form>
