                                ...
                                <table id="member_capture_completeProgressTable" class="table table-striped " style="width:100%; background:rgba(219, 219, 219, 0.877);">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/dashboard/{{ $memberCapture_CompletedForm_MainMember->mm_id }}/edit" class="btn btn-sm edit" title="Edit" style="margin-bottom: 0.5em; border: 1px solid #010e46; border-radius: 0.2em;">
