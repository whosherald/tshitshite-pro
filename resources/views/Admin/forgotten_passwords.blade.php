                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="p-3">
                                    ...
                                    <p class="text-muted text-center mb-4">Hello {{ $username }}, enter your email to change your password!</p>
                                    @if(Session::has('fail'))
                                    ...
                                    @endif
                                    <form class="form-horizontal" action="{{ url('/change-forgotpssword') }}" method="post">
                                    @csrf
                                        ...
                                        <div class="mb-3">
                                            <div class="text-end">
                                                <button class="btn w-md waves-effect waves-light" type="submit"style="border-radius:25rem ! important;margin-left:73.5%;background: rgb(8, 21, 70);">Submit</button>
                                            </div>
                                        </div>
                                    </form>
